...
def parse_data_with_gpt(text):
    """
    Usa GPT per:
    - identificare il tipo documento
    - estrarre tutti i campi rilevanti
...
Devi:
1. Identificare il tipo documento (fattura, contratto, carta_identita, ricevuta, referto_medico, ecc)
2. Estrarre TUTTI i dati possibili.
...
- non inventare dati
- se un valore non è certo non inserirlo
...
"""
        ...
        # pulizia JSON se GPT mette ```json
