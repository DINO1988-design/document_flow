...
def home_page():
    ...
    <div style="display:flex; justify-content:space-between; gap:20px;">
        <!-- Colonna sinistra: upload e lista documenti -->
        ...
        <div style="width:450px;">
            <section style="margin-bottom:20px;">
                ...
                <canvas id="chartTipo" style="width:100%; height:300px;"></canvas>
            </section>
            <section>
    ...
    // Funzioni upload, load documenti, modal e download come prima
    // --- Upload ---
    ...
    async function loadDocs(){
        ...
        } else { table.clear(); table.rows.add(data); table.draw(); }
        ...
        if(pendingFiles.length){
            ...
            if(processedCount === pendingFiles.length){
                ...
                pendingFiles = [];
                setTimeout(()=>{ document.getElementById("progressContainer").style.display="none"; document.getElementById("progressBar").style.width="0%"; }, 1500);
            }
        }
    ...
    async function updateCharts(){
        ...
        document.getElementById("kpi_total").innerText = totalDocs;

        const today = new Date().toISOString().slice(0,10);
        document.getElementById("kpi_today").innerText = stats.date_count[today] || 0;
        ...
        document.getElementById("kpi_tipo").innerText = maxTipo;

        if(dateLabels.length){
            document.getElementById("kpi_last").innerText = dateLabels[dateLabels.length-1];
        }
            }
