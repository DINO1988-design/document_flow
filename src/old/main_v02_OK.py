...
def parse_data_with_gpt(text):
    try:
        ...
        2. Estrai **tutti i dati importanti**, scegliendo chiavi descrittive in italiano.
        3. Rispondi **solo con JSON valido** in questo formato:
        ...
        Non limitarti a nome, cognome, codice fiscale, iban o importo.
        Metti tutte le informazioni che riesci a trovare.
        ...
        # QUI va messo il parsing sicuro
