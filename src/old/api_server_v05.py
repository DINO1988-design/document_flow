...
def home_page():
    ...
    <section style="margin-bottom: 20px;">
        ...
        <form id="uploadForm" enctype="multipart/form-data" style="display:flex; gap: 10px; align-items:center;">
            <input id="fileInput" name="file" type="file" style="padding: 5px; border-radius: 4px; border: 1px solid #ccc;" required>
        ...
        <div id="progressContainer" style="width:100%; background:#e0e0e0; border-radius:6px; margin-top:10px; display:none;">
            <div id="progressBar" style="width:0%; height:16px; background:#28a745; border-radius:6px;"></div>
        </div>
    ...
    async function loadDocs() {
        ...
        // Aggiorna barra progresso solo per file presenti nella tabella
