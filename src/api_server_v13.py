...
def home_page():
    ...
    document.getElementById("filterDateBtn").onclick = loadDocs;
    ...
    async function showDetails(docId){
        ...
        if(fileExt==='pdf'){
            html += `<iframe src="/uploads/${filename}" width="100%" height="400px"></iframe>`;
        } else if(['png','jpg','jpeg','gif'].includes(fileExt)){
            html += `<img src="/uploads/${filename}" style="max-width:100%; max-height:400px; display:block; margin-bottom:10px;">`;
        }
